setwd("~/Dropbox/zongyi/code/sim_class_1/code")
setwd("~/local_dropbox/zongyi/code/sim_class_1/code")
...
test <- readRDS("../data/sim_data_lin_corr_reg.rds")
...
for (cc in 1:10) {
    res1 <- readRDS(paste0("../data/comp_sim1_reg_", cc, ".rds"))
...
for (cc in 1:10) {
    res2 <- readRDS(paste0("../data/gp_sim1_reg_", cc, ".rds"))
