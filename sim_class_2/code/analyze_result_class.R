...
test <- readRDS("../data/sim_data_nonlin_corr.rds")
...
for (cc in 1:10) {
    res1 <- readRDS(paste0("../data/comp_sim2_", cc, ".rds"))
...
for (cc in 1:10) {
    res2 <- readRDS(paste0("../data/gp_sim2_", cc, ".rds"))
    ...
    colnames(dftrain)[2] <- colnames(dftest)[2] <- "Int"
    ## logistic regression
